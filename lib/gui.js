...
// select-to-radios from https://bl.ocks.org/mootari/bfbf01320da6c14f9cba186c581d507d
...
const fpGui = new dat.GUI()
fpGui.remember(params.fill)
...
var olGui = new dat.GUI()
olGui.remember(params.outline)
olGui.add(params.outline, 'strokeWeight').min(0).max(100).step(1)
