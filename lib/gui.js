...
let params = Object.assign({}, params_1, flattenObj(fillParams, 'fill'), flattenObj(outlineParams, 'outline'))
...
const swapPrefixParams = (params, prefix1, prefix2) => {
  // since they're prefix vals, and not objects, we need the prefixes to swap, right?
  // not sure about outline stuff, though. hunh.
  // and is everything in the GUI listening?
  // or can we issue a general refresh?
  ...
  let p1bak = pick(newParams, p1keys)
